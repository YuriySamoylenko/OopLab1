...
0 – Exit to main menu");
        ...
        switch (findNumber)
        {
            ...
            case 2:
                ...
                machine.OperatorName = ReadUserString("Enter operator name (string length 3 - 20): ", 3, 20);
                machine.Phone = ReadUserDigits("Enter operator phone number (digits length 6): ", 6, 6);
